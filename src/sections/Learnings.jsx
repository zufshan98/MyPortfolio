...
const Achievements = () => {
  return (
    <section id='learnings' className='w-full flex relative items-center justify-center'>
      ...
      {/** Wrapper Container */}
        <div className=' relative w-full mx-auto px-6 md:px-10 lg:px-12 flex flex-col justify-center items-center mt-20 gap-15'>
          ...
          <div className='w-full mx-auto flex flex-wrap justify-around py-15 mb-15'>

            <div className=' bg-darkgreen/60 p-10 h-95 w-95 rounded-full flex flex-col justify-center items-center gap-10'>

              <div className='flex flex-col justify-around items-center gap-4'>

                <div className='w-full flex-col justify-around items-center'>
                  <img src={Gsoc} alt="" className='w-15 h-15 mx-auto rounded-2xl'/>
            ...
            <div className=' bg-darkgreen/60 p-10 h-95 w-95 rounded-full flex flex-col justify-center items-center gap-4'>

              <div className='w-full flex-col justify-around items-center'>
                  <img src={Java} alt="" className='w-15 h-15 mx-auto rounded-2xl'/>
            ...
            <div className=' bg-darkgreen/60 p-10 h-95 w-95 rounded-full flex flex-col justify-center items-center gap-2'>
            
              <div className='w-full flex-col justify-around items-center'>
                  <img src={Certificate} alt="" className='w-15 h-15 mx-auto rounded-2xl'/>
